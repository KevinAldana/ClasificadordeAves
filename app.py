...
names = ['AMARANTA OCRE','ALBATROSS','COTORRA ALEJANDRINA','AVOCETA AMERICANA','AVETORO LENTIGINOSO',
         'FOCHA AMERICANA','JILGUERO NORTEAMERICANO','CERNICALO AMERICANO','BISBITA NORTEAMERICANO','CANDELITA NORTEÑA']
